...
public class CurrentRoadWorksParser extends AsyncTask {
    ...
    protected Object doInBackground(Object[] objects) {
        ...
        try {
            // sets the url
            url = new URL("http://trafficscotland.org/rss/feeds/currentincidents.aspx");//changed to planned!!!
...
//adds roadworks to the array
       ...
       // currentRoadWorks.set(0, "Current Incidents");
        return currentRoadWorks;

    }

    public ArrayList<String> getCurrentRoadWorks()
    {
        return currentRoadWorks;
    }
}
